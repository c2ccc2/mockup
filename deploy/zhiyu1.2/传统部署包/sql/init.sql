...
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '内容管理' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 31 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '文章分类' ROW_FORMAT = DYNAMIC;
...
-- ----------------------------
-- Table structure for article_ref_category
-- ----------------------------
DROP TABLE IF EXISTS `article_ref_category`;
CREATE TABLE `article_ref_category`  (
  `article_ref_id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键id',
  ...
  `update_by` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL COMMENT '更新人',
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`article_ref_id`, `category_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '文章分类关联' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `discuss`  (
  `discuss_id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '评论id',
  `article_id` bigint(20) NOT NULL COMMENT '文章id',
  `content` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '评论内容',
  `editor_type` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT 'html' COMMENT '编辑器类型markdown,html',
  `create_by` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL COMMENT '创建人',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `update_by` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL COMMENT '更新人',
...
-- ----------------------------
-- Table structure for file_ref_info
-- ----------------------------
DROP TABLE IF EXISTS `file_ref_info`;
CREATE TABLE `file_ref_info`  (
  `file_ref_info_id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '文件关联id',
  `file_id` bigint(20) NOT NULL COMMENT '文件id',
  `ref_table_id` bigint(20) NOT NULL COMMENT '关联的表的列id',
  `business_name` varchar(300) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '业务名称',
  `business_class_name` varchar(300) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '业务文件分类',
  PRIMARY KEY (`file_ref_info_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '文件关联表' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 13 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '项目原型表' ROW_FORMAT = DYNAMIC;



INSERT INTO `mockup` VALUES (5, 1, '前端原型', 0, 'admin', '2025-07-18 17:55:29', 'admin', '2025-07-24 12:27:29');
INSERT INTO `mockup` VALUES (12, 1, '后端原型', 0, 'admin', '2025-07-24 12:37:24', NULL, NULL);
...
CREATE TABLE `project_file`  (
  `project_file_id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '项目文件记录ID',
  `project_id` bigint(20) NOT NULL COMMENT '项目ID',
  `zip_file_path` varchar(300) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '压缩文件路径',
  `html_file_path` varchar(300) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT 'html文件路径',
  `version` int(11) NOT NULL DEFAULT 1 COMMENT '项目文件版本',
  `upload_title` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '上传标题',
  `upload_description` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '最新上传的说明',
  `state` int(11) NOT NULL COMMENT '状态',
  `prototype_file_path` varchar(300) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '原型文件路径',
  `requirements_file_path` varchar(300) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '需求文件路径',
  `effect_picture_file_path` varchar(300) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '效果图文件路径',
  `create_by` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL COMMENT '创建人',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `update_by` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL COMMENT '更新人',
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  `mockup_id` bigint(20) NOT NULL COMMENT '项目原型ID',
  PRIMARY KEY (`project_file_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '项目文件表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `sys_file`  (
  ...
  `RealName` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '文件原名',
  `FileType` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '文件类型',
  `FileName` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '存储文件名',
  `FileUrl` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '文件存储地址 eg：/uploads/20220202',
  `StorePath` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '仓库位置 eg：/uploads',
  `FileSize` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '文件大小',
  `FileExt` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '文件扩展名',
  `AccessUrl` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '访问路径',
  `ClassifyType` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '分类',
  `create_by` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL COMMENT '创建人',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `update_by` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL COMMENT '更新人',
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`file_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 16 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '文件存储表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `sys_menu` VALUES (2039, '知识库管理', 2026, 2, NULL, NULL, NULL, 1, 0, 'F', '0', '0', NULL, NULL, 'admin', '2025-07-02 20:51:27', '', NULL, '');
...
-- ----------------------------
-- View structure for view_project_file_max_version
-- ----------------------------
DROP VIEW IF EXISTS `view_project_file_max_version`;
CREATE ALGORITHM = UNDEFINED SQL SECURITY DEFINER VIEW `view_project_file_max_version` AS select `project_file`.`mockup_id` AS `mockup_id`,max(`project_file`.`version`) AS `version` from `project_file` group by `project_file`.`mockup_id`;
